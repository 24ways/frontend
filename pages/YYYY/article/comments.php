        ...
        <form id="comment" method="post">
            <fieldset class="section">
                ...
                <div class="section_main">
                    ...
                    <p class="field">
                        <label class="field_label" for="commentName">Name</label>
                        <input class="field_input" id="commentName" name="commentName" type="text" required="required"/>
                    </p>
                    <p class="field">
                        <label class="field_label" for="commentEmail">Email</label>
                        <input class="field_input" id="commentEmail" name="commentEmail" type="email" required="required"/>
                    </p>
                    <p class="field">
                        <label class="field_label" for="commentURL">Website</label>
                        <input class="field_input" id="commentURL" name="commentURL" type="url" placeholder="http://"/>
                    </p>
                    <p class="field">
                        <label class="field_label" for="commentHTML">Message</label>
                        <textarea class="field_input" id="commentHTML" name="commentHTML" cols="25" rows="5" required="required"></textarea>
                    </p>
                    <p>
